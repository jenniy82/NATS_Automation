...
input_to_Nats = '{"properties":{"sourceIp":"10.160.178.30","sourceNodeID":"2687540205173066847","sourceName":"FLOW"},"sessions":[{"prot":5,"sIP":"10.160.178.36","cIP":"10.160.112.1","sPrt":22,"cPrt":62198,"time":0,"bid":true,"exporterIp":"127.0.0.1","dirConf":"HIGH"},{"prot":17,"sIP":"10.160.178.20","cIP":"10.160.112.1","sPrt":31364,"cPrt":62397,"time":1584292383,"bid":false,"exporterIp":"127.0.0.1","dirConf":"LOW"}]}'
print("start")
...
pulsar_output_payload_list = output_handler.get_pulsar_output('pulsar://10.160.178.100:6650','internal/flowsUploader/flows')

# compare input output class
compare_input_output = Compare_input_output(sessions_list,pulsar_output_payload_list,attributes,attributes_for_hash)
...
output_hash_map = compare_input_output.create_hash_map_for_flows(pulsar_output_payload_list)
